...
全球限量 **500台**，该版本采用专属的**10周年黑灰色外观设计**，同时保持与 **myCobot 280 M5** 相同的硬件规格、软件兼容性以及开发体验。

**myCobot 280 X Edition - M5 与 myCobot 280 M5 的区别仅在于外观设计。** 两者在核心功能、性能参数、软件生态、SDK、教程资源以及兼容配件方面均保持一致，用户可继续使用现有的开发资源和使用方式。

---

## 兼容性说明

**myCobot 280 X Edition - M5 与 myCobot 280 M5 基于相同的硬件平台打造。**

现有针对 **myCobot 280 M5** 的软件资源、SDK、教程文档以及配套配件均可完全兼容 **myCobot 280 X Edition - M5**。用户无需进行额外修改，即可按照相同的开发指南和使用流程进行开发与应用。

---

## 版本对比

| 特性 | myCobot 280 X Edition - M5 | myCobot 280 M5 (2023) |
| --- | --- | --- |
| 外观 | 黑灰色 | 白色 |
| 自由度 | 6 轴 | 6 轴 |
| 负载 | 250g | 250g |
